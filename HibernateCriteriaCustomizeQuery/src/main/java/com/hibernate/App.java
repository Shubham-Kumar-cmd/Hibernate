...
public class App 
{
    public static void main( String[] args )
    {
        ...
        //cq.select(restricationOnQuery).where(cb.equal(restricationOnQuery.get("id"),378));
        ...
        //it will fetch all the Items like, java, Spring Boot etc. in course attribute
        //cq.select(restricationOnQuery).where(restricationOnQuery.get("certi.course").in("java", "Spring Boot", "Angular"));
